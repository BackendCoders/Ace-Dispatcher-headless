...
function Footer() {
	...
	return (
		<div className='flex flex-col sm:flex-row justify-between h-auto sm:justify-center items-center sm:h-8 w-full fixed bottom-0 bg-[#ffffff] sm:bg-[#ffffff] text-gray-200 uppercase text-sm sm:p-0'>
			{/* {isAuth && (
