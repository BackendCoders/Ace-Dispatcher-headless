    ...
    <div className="bg-background text-foreground p-3 m-auto">
      <form autoComplete="off" id="myForm" action="" onSubmit={handleSubmit}>
        <>
          ...
          <Modal open={confirmCoaModal} setOpen={setConfirmCoaModal}>
            <ConfirmCOA
          ...
          <Modal open={isWarningOpen} setOpen={setIsWarningOpen}>
            <WarningModal
            ...
            <div className="flex gap-5 flex-col md:flex-row">
              <input
                ...
                onChange={(e) => {
                  ...
                  // if (arriveByFlag) updateData('arriveBy', e.target.value); arrive by not change on changing of pickup time
